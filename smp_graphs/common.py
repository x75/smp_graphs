...
def get_input(inputs, inkey):
    ...
    A bus operation, returns the 'val' field of the inputs' item at
    'inkey' making sure inkey exists in inputs and fail otherwise
    """
    return get_dict_val(inputs, inkey)
