...
def get_args():
    ...
    parser.add_argument("-dr", "--do-ros",    dest="ros", action="store_true",    help = "Do / enable ROS?")
    parser.add_argument("-nr", "--no-ros",    dest="ros", action="store_false",   default = False, help = "No / disable ROS?")
