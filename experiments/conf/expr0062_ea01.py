...
graph = OrderedDict([
    ...
    # measures: direct pre2meas
    get_measures_block(**{
        'measblockid': 2, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': p_del_vars,
        'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'kld'}),

    # measures: indirect mdlpre2meas
    get_measures_block(**{
        'measblockid': 3, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': ['mdl1/y'],
        'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'kld'}),
        
    # measures: direct pre2meas
    get_measures_block(**{
        'measblockid': 4, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': p_del_vars,
        'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'pyemd'}),

    # measures: indirect mdlpre2meas
    get_measures_block(**{
        'measblockid': 5, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': ['mdl1/y'],
        'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'pyemd'}),
    ...
    ('plot', {
        ...
        'params': {
            ...
            'inputs': {
                ...
                'm_div': {'bus': 'm_div0/y', 'shape': (1, numbins)},
                'm_sum_div': {'bus': 'm_div0_sum/y', 'shape': (1, 1)},
                'm_div_kld': {'bus': 'm_div2/y', 'shape': (1, numbins)},
                'm_sum_div_kld': {'bus': 'm_div2_sum/y', 'shape': (1, 1)},
                'm_div_emd': {'bus': 'm_div4/y', 'shape': (1, numbins)},
                'm_sum_div_emd': {'bus': 'm_div4_sum/y', 'shape': (1, 1)},
            },
            'desc': """System and model transfer functions""",
            # subplot
            'subplots': [
                # row 1: transfer func, out y time, out y histo
                [
                    {
                        'input': ['sys_h', 'mdl1_h'], 'plot': partial(timeseries), # color = 'black'
                        'aspect': 1.0,
                        'cmap': ['rainbow'], # 'cmap_off': [],
                        'title': None, # 'transfer function $h$', 'aspect': 1.0, 
                        'xaxis': np.linspace(-1, 1, 1001), # 'xlabel': 'input [x]',
                        'xlim': (-1.1, 1.1),
                        'ylim': (-1.1, 1.1),
                        'xticks': (-1, 0, 1), # True,
    ...
    ('table', {
        ...
        'params': {
            ...
            'inputs': {
                ...
                'm_div2_sum': {'bus': 'm_div2_sum/y', 'shape': (1, 1)},
                'm_div4_sum': {'bus': 'm_div4_sum/y', 'shape': (1, 1)},
                ...
                'm_div3_sum': {'bus': 'm_div3_sum/y', 'shape': (1, 1)},
                'm_div5_sum': {'bus': 'm_div5_sum/y', 'shape': (1, 1)},
            },
            'layout': {
                'numrows': 8,
                'numcols': 3,
                ...
                'cells': [
                    ...
                    [None, 'm_div2_sum', 'm_div3_sum'],
                    [None, 'm_div4_sum', 'm_div5_sum'],
                ],
            },
        },
    }),
