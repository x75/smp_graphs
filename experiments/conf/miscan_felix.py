...
ppycnf2 = {
    # 'logfile': '../../data/felix/seqs/circles.pickle',
    # 'numsteps': 2000, # 2049
    'logfile': '../../data/felix/seqs/semi-random.pickle',
    'numsteps': 2400, # 2437,
    'logtype': 'puppy',
    'xdim': 2,
    'xdim_eff': 2,
    'ydim': 2,
    'sys_slicespec': {'x': {'all': slice(0, 2)}},
}
...
graph = OrderedDict([
    ...
    # slice block to split puppy sensors x into gyros x_all and accels x_acc
    ('puppyslice', {
        'block': SliceBlock2,
        'params': {
            'id': 'puppyslice',
    ...
    ('mimv', {
        ...
        'params': {
            'id': 'mimv',
            'loop': [('inputs', {'x': {'bus': 'puppyslice/x_all'}, 'y': {'bus': 'puppylog/y'}}),
    ...
    ('cte', {
        ...
        'params': {
            'id': 'cte',
            'loop': [('inputs', {'x': {'bus': 'puppyslice/x_all'}, 'y': {'bus': 'puppylog/y'}, 'cond': {'bus': 'puppylog/y'}}),
                     # ('inputs', {'x': {'bus': 'puppylog/x'}, 'y': {'bus': 'puppylog/r'}}),
                     # ('inputs', {'x': {'bus': 'puppylog/y'}, 'y': {'bus': 'puppylog/r'}}),
            ],
            'loopmode': 'parallel',
            'loopblock': {
                ...
                'params': {
                    ...
                    'debug': False,
                    'xcond': True,
                    'inputs': {'x': {'bus': 'puppyslice/x_all'}, 'y': {'bus': 'puppylog/y'}, 'cond': {'bus': 'puppylog/y'}},
                    'shift': (scanstart, scanstop),
