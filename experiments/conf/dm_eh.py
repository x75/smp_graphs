    ...
    ('brain_learn_proprio', {
        ...
        'params': {
            'graph': OrderedDict([
                ...
                #             # 'f': {'val': np.array([[0.23539]]).T * 4.5 * dt}, # good with soesgp and eta = 0.7
                ...
                #             # 'f': {'val': np.array([[0.23539]]).T * 1.6 * dt}, # good with soesgp and eta = 0.7
                    ...
                    'params': {
                        ...
                        'models': {
                            ...
                            'm1': {
                                ...
                                'lrname': 'eh',
                                'algo': algo,
                                'perf_measure': meas.sum_abs, # meas.abs, # abs, square, sum_abs, sum_square, sum_sqrt
                                'memory': maxlag,
                                'laglen': laglen,
                                'minlag': minlag,
                                'maxlag': maxlag,
