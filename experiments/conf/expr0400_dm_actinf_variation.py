...
the washout period nothing happens but as soon as the predictor update
is enabled, the proprioceptive goal to state prediction error is
almost instantly brought down. In the remaining learning phase the
error gets close to zero and remains to even during testing.
""".format(escape_backslash(goal))
