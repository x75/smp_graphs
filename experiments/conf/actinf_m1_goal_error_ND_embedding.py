...
# maxlag = 5 # 10 # last return to consider / window length
...
# # for sa
# dim_s_proprio = 3 # two joint angles
# dim_s_extero = 3  # 2D end-effector
# dt = 0.1
# lag = 1
# minlag = 1 # 1  # first returning measurement offset in time steps
...
get_systemblock = {
    ...
    'lpzbarrel': partial(get_systemblock_lpzbarrel, dim_s_proprio = 2, dim_s_extero = 1, dt = 2.0/93.0), # 0.025),
                ...
                ('pre_l1', {
                    ...
                    'params': {
                        ...
                        'inputs': {
                            ...
                            'f': {'val': np.array([[0.31]]).T * 5.0 * dt}, # good with soesgp and eta = 0.7
