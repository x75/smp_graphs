    ...
    ('brain', {
        ...
        'params': {
            ...
            'graph': OrderedDict([
                ...
                # measures: direct pre2meas
                get_measures_block(**{
                    'measblockid': 2, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': p_vars,
                    'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'kld'}),

                # measures: indirect mdlpre2meas
                get_measures_block(**{
                    'measblockid': 3, 'numsteps': numsteps, 'p_vars': ['delay/dy'], 'p_del_vars': p_del_vars,
                    'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'kld'}),

                # measures: direct pre2meas
                get_measures_block(**{
                    'measblockid': 4, 'numsteps': numsteps, 'p_vars': p_vars, 'p_del_vars': p_vars,
                    'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'pyemd'}),

                # measures: indirect mdlpre2meas
                get_measures_block(**{
                    'measblockid': 5, 'numsteps': numsteps, 'p_vars': ['delay/dy'], 'p_del_vars': p_del_vars,
                    'm_vars': m_vars, 'dim_s0': dim_s0, 'numbins': numbins, 'div_meas': 'pyemd'}),
            ]),
        }
    }),
                ...
                [
                    {
                        ...
                        'title': None, # 'transfer function $h$',
                        'aspect': 1.0, 
                        'xaxis': np.linspace(-1, 1, 1001), # 'xlabel': 'input [x]',
                        'xlim': (-1.1, 1.1),
                        'ylim': (-1.1, 1.1),
                    ...
                    },
                    {
                        ...
                        # normalize to original range
                        'ylim': (-0.1, 2.1), # None,
                        'legend': {'Fast error': 0, 'Slow error': 1, 'Learning': 4},
                        'legend_loc': 'left',
                    },
                ],
            ],
