...
dim_s_extero = 1 # 1 for lpzbarrel
# dim_s_proprio = 3 # three sonar rangers stdr
dim = dim_s_proprio
                ...
                ('pre_l1', {
                    ...
                    'params': {
                        ...
                        'inputs': {
                            ...
                            'f': {'val': np.array([[0.23539, 0.23539]]).T * 5.0 * dt}, # good with soesgp and eta = 0.7
                ...
                ('pre_l0', {
                    ...
                    'params': {
                        ...
                        'inputs': {
                            ...
                            # measurement
                            'meas_l0': {
                                'bus': 'robot1/s_proprio', 'shape': (dim, lag+1)}},
                        'outputs': {
                            'pre': {'shape': (dim, 1)},
                            'err': {'shape': (dim, 1)},
                            'tgt': {'shape': (dim, 1)},
